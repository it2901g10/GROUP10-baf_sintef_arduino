package no.ntnu.osnap.arduinointerface;
...
public class Protocol implements ComLayerListener {
    ...
    private ArduinoBluetoothConnection board;
    private Command currentCommand;
    
    private Byte waitingForAck;

    public Protocol(ArduinoBluetoothConnection connection) {
        currentCommand = new Command();
        waitingForAck = null;        
        board = connection;
        board.addComLayerListener(this);
    }
