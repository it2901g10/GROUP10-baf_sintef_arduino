...
public class Group extends Model implements Parcelable {
	...
	/**
	 * Constructs a Group from a source JSON text string, performing a field
	 * name translation.
	 *
	 * @param json a JSON string, starting with { and ending with }
	 ...
	 *
	 * @return the value of the field 'title' as a {@code String} or an empty
	 * {@code String} if no value is associated with such field
	 */
	 ...
	 *
	 * @return the value of the field 'description' as a {@code String} or an
	 * empty {@code String} if no value is associated with such field
	 */
