...
smartphones, social networks are becoming accesible everywhere. The aim of this
work is to demonstrate, and if possible simplify, the feasibility of tangible user
interfaces for social networks. Three tangible user interface prototypes of
different complexity were developed using an open source electronic prototyping
...
feasible and could have applications in various scenarios such as a aid in
