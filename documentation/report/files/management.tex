...
We set some project-level milestones (see \ref{tbl:milestone}) for ourselves. They took into account both
course's deadlines and the actual achievements towards the final product. In order to plan our activities we
