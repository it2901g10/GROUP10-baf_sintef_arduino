...
\caption{The Waterfall model~\cite{link:wiki}}
...
frameworks to limit the effort required by the task. If later these show to have severe
limitations the product could result poorer in features than we originally planned.
The impact can be negligible if other solutions are found.
...
Evolving requirements	& 7 & 8 & 8
			& Specify a set of requirements that both the customer and the devolopers agree on.
