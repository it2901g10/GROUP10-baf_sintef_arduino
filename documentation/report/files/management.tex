...
which development processes we have considered to use. The choice of the development method
will affect how the group communicates, collaborates and write the code.

Write a little about each of these:
Scrum
