...
Communication library completed & ?-?-2012 \\
\hline

Social library completed & ?-?-2012 \\
\hline
...
These include:\newline
\begin{itemize}
	\item{IDEs of choice:} NetBeans, Eclipse, Android/SublimeText \newline
	\item{Collabaration tools:} Git, Skype, Google Docs\newline
	We decided to use Git, which is a fast, scalable,
	...
	Also some team members had already used it with success in
	other projects and that was also a factor that led to this choice.
	Skype for instant message communication, and Google Docs for real
	time documentation collaboration.
	\item{Pre-existing software:} Facebook Android SDK, Android SDK\newline
	\item{LaTex editors:} used for producing documentation.
\end{itemize}
