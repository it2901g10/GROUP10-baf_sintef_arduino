...
\begin{itemize}
	...
	\item{Arduino developers:} Johan Jansen and Asbjørn Lucassen\newline
...
\begin{itemize}
	\item{IDE for Coding:} \newline
	NetBeans and Eclipse for Java development and Arduino for embedded C development.

	\item{Collabaration tools:} \newline
	We decided to use GIT, which is a fast, scalable, distributed revision control system with an unusually 
	rich command set that provides both high-level operations and full access to internals. Also several 
	team members had experience with GIT through other projects which was a significant factor for 
	this choice.
	...
	\item{\LaTeX{}:} \newline
	Used for producing documentation.
\end{itemize}
