...
\raggedright\subsubsection{Framework part one:} Retrieving and uploading data between social service and java.
\subsubsection{Framework part two:} Grab and push data between the Arduino board and java.
