...
The figure \ref{fig:design-toplevel} illustrates the overall system architecture, demonstration 3 Applications that use only the communication library, only the social service library, or both.
...
the connection to the social networks. This is done by estabilishing a communication interface (using Android's Intent mechanism)
