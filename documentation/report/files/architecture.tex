...
connection between all the applications and the oSNAP SocialLib. This is intentional because some of the prototypes we
...
the project scope, and went on to solve a very ambitious and unneeded task. The new design also accommodated
...
used to quickly prototype Arduino Tangible User Interfaces. One of the prototypes, the T-Shirt, is significantly
