...
\subsection{T-Shirt application and Service}

\begin{figure}[h!]
\centering \includegraphics[scale=0.35]{img/req-tshirtappusecase}
\caption{Use case }
\label{fig:design-resp}
\end{figure}

\subsection{Facebook application and Service}

The Facebook application design had to be reviewed after roughly one month.

\begin{figure}[h!]
\centering \includegraphics[scale=0.35]{img/req-socialappusecase2}
