...
like the group to work on. Mr. Babak liked the t-shirt idea, and he decided that the t-shirt would be the main prototype for this project. After some iterations the t-shirt got swapped out with a jacket due to practical reasons for implementing the hardware.(\link:Android) 
The prototypes is to show that our libraries can connect social networks (Twitter, Facebook, etc.) to tangible Arduino interfaces (LED, buzzer, sound, buttons, etc.).
