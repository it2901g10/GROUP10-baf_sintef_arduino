...
\item[Android-Arduino applications:]
	With this term we refer to Android applications used to control the behavior of Arduino-base T.U.I.
\item[Apache:]
...
\item[Social service:]
	With this term we refer to Android services, used to fetch data from a social network.
\item[TUI:]
